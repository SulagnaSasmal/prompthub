...
from app.routers import auth, audit, dashboard, evaluations, governance, prompts, tests, versions, webhooks, workflow_v2, workflow_v3
...
for router in [auth.router, prompts.router, versions.router, evaluations.router,
               tests.router, governance.router, dashboard.router, audit.router, workflow_v2.router, workflow_v3.router, webhooks.router]:
